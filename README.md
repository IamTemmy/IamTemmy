...
I build systems that **sense the physical world, make decisions, and prove whether they worked.**

I'm working toward a career across **hardware, product, and systems engineering** — especially where software meets the physical world.
...
A faithful PyTorch reproduction of NVIDIA's PilotNet: one forward-facing camera frame directly predicts a steering angle.

**MAE 0.077** · **94.2% within ±0.20**

<sub>PyTorch · CNN · end-to-end learning · autonomous driving</sub>
